...
def run_repo(
    ...
    return {
        ...
        "call_graph_artifact_exists": data.get("phase_3_call_graph_artifact_exists", ""),
        "call_graphs_generated": data.get("phase_3_call_graphs_generated", ""),
        "call_graph_non_empty_results": data.get("phase_3_non_empty_call_graphs", ""),
        "call_graph_edges_generated": data.get("phase_3_call_edges_generated", ""),
        "jsonl_call_edges_serialized": data.get("phase_5_call_edges_serialized", ""),
